...
export interface ApiCanvasCanvas extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    pixels: Schema.Attribute.Relation<'oneToMany', 'api::pixel.pixel'>;
    publishedAt: Schema.Attribute.DateTime;
    rndName: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPixelPixel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    canvas_id: Schema.Attribute.String;
    canvase: Schema.Attribute.Relation<'oneToOne', 'api::canvas.canvas'>;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    canvases: Schema.Attribute.Relation<'oneToOne', 'api::canvas.canvas'>;
